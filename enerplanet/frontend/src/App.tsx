...
const MapComponent = lazy(() =>
  import("./features/interactive-map").then((module) => ({ default: module.MapComponent }))
);
const EnergyRiskDashboard = lazy(() =>
  import("@/features/model-dashboard/components").then((module) => ({
    default: module.EnergyRiskDashboard,
  }))
);
const Dashboard = lazy(() =>
  import("@/features/admin-dashboard").then((module) => ({ default: module.Dashboard }))
);
const FeedbackComponent = lazy(() =>
  import("@/features/user-feedback").then((module) => ({ default: module.FeedbackComponent }))
);
...
const AreaSelect = lazy(() =>
  import("@/features/configurator/region-selector/AreaSelect").then((module) => ({
    default: module.AreaSelect,
  }))
);
const AssessmentViewer = lazy(() =>
  import("@/features/assessment-viewer").then((module) => ({ default: module.AssessmentViewer }))
);
const ModelResultsViewer = lazy(() =>
  import("@/features/model-results").then((module) => ({ default: module.ModelResultsViewer }))
);
const TechnologiesPage = lazy(() => import("@/features/technologies/TechnologiesPage"));
const LocationsPage = lazy(() =>
  import("@/features/locations").then((module) => ({ default: module.LocationsPage }))
);
const LocationCreator = lazy(() =>
  import("@/features/locations").then((module) => ({ default: module.LocationCreator }))
);
const LocationViewer = lazy(() =>
  import("@/features/locations").then((module) => ({ default: module.LocationViewer }))
);
const SimulationCharts = lazy(() =>
  import("@/features/simulation-charts").then((module) => ({ default: module.SimulationCharts }))
);
const LegalPage = lazy(() => import("@/pages/legal/LegalPage"));
const LandingPage = lazy(() => import("./features/landing"));
const NodeModellerPage = lazy(() => import("@/features/node-modeller/host/NodeModellerPage"));
              ...
              <Suspense fallback={<PageLoader />}>
                <Routes>
                  ...
                  <Route element={<Middleware type="auth" />}>
                    ...
                    <Route
                      path="/app/model-dashboard/edit/:id"
                      element={<AreaSelect editMode={true} />}
                    />
                    ...
                    <Route path="/app/simulation-reports" element={<SimulationCharts />} />
                    <Route path="/app/simulation-reports/:modelId" element={<SimulationCharts />} />
                    <Route path="/app/node-modeller" element={<NodeModellerPage />} />
                    ...
                    <Route
                      path="/app/locations/edit/:id"
                      element={<LocationCreator editMode={true} />}
                    />
