...
are written against. Full ten-persona set (including grid-only and results-only
personas not relevant to this feature) is in the brain vault's
`thesis/building-configurator/wp3-user-stories-mapping.md`.
