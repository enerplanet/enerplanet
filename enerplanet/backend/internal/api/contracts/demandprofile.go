...
// --- Model demand-profile poll endpoint ---
...
// ModelDemandProfilesResponse is the response for GET /models/{id}/demand-profiles.
//
// status is one of:
...
type ModelDemandProfilesResponse struct {
	...
	Buildings []BuildingDemandProfile `json:"buildings"`
}
